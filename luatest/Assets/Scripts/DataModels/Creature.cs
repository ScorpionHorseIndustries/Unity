...
//    private static Dictionary<string, Creature> prototypes = new Dictionary<string, Creature>();


//    public static void LoadFromFile() {

//      string path = System.IO.Path.Combine(Application.streamingAssetsPath, "data", "Creatures");
...
//        JObject creatureJson = JObject.Parse(json);
//        Creature creature = new Creature();
//        creature.type = Funcs.jsonGetString(creatureJson["name"], null);
//        creature.niceName = Funcs.jsonGetString(creatureJson["niceName"], null);
//        creature.spriteName = Funcs.jsonGetString(creatureJson["spriteName"], null);
//        creature.onUpdate = Funcs.jsonGetString(creatureJson["onUpdate"], null);

//        prototypes.Add(creature.type, creature);
